...
namespace HerglaPark
{
    ...
    public class TrackTirePlacerEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            // Bouton pour configurer le MeshCollider de la piste
            GUI.backgroundColor = new Color(0.18f, 0.55f, 0.85f); // Bleu
            if (GUILayout.Button("🛠️ Configurer MeshCollider Non-Convexe", GUILayout.Height(30)))
            {
                placer.SetupTrackCollider();
            }
