...
export const PRESET_COLORS = [
  { nameKey: 'karts.colors.rougeHergla', hex: '#E53935' },
  { nameKey: 'karts.colors.bleuRacing', hex: '#1E88E5' },
  { nameKey: 'karts.colors.vertPiste', hex: '#4CAF50' },
  { nameKey: 'karts.colors.jauneJaillissant', hex: '#FBC02D' },
  { nameKey: 'karts.colors.orangeNitro', hex: '#FB8C00' },
  { nameKey: 'karts.colors.violetSpeed', hex: '#8E24AA' },
  { nameKey: 'karts.colors.cyanTurbo', hex: '#00ACC1' },
  { nameKey: 'karts.colors.noirCarbone', hex: '#263238' },
];
    ...
    >
      ...
      <div className="w-28 flex-shrink-0">
        ...
        <div className="relative">
          <input
            ...
            placeholder={t('karts.raceNumberPlaceholder')}
            maxLength={3}
              ...
              {PRESET_COLORS.map((preset) => (
                ...
                >
                  <span
                    ...
                    style={{ backgroundColor: preset.hex }}
                  />
                  <span className="truncate">{t(preset.nameKey).split(' ')[0]}</span>
                </button>
              ))}
            </div>
            <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-2">
              <span className="text-[11px] font-medium text-slate-500">{t('karts.liveryColor')} :</span>
              <input
                type="color"
      ...
      <div className="flex flex-col items-center">
        ...
        <button
          ...
          title={kart.actif !== false ? t('karts.inService') : t('karts.maintenanceKarts')}
        >
          <Power size={13} />
          <span>{kart.actif !== false ? t('karts.inService') : t('karts.maintenanceKarts')}</span>
        </button>
      </div>
